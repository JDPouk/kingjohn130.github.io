...
class FieldtypePhone extends \ProcessWire\Fieldtype implements \ProcessWire\Module, \ProcessWire\ConfigurableModule {


    public static function getModuleInfo() {
        return array(
            'title' => \ProcessWire\__('Phone', '/home/jpoukco/public_html/site/modules/FieldtypePhone/FieldtypePhone.module.php'),
            'summary' => \ProcessWire\__('Multi part phone field, with custom output formatting options.', '/home/jpoukco/public_html/site/modules/FieldtypePhone/FieldtypePhone.module.php'),
            'version' => '3.1.0',
            'author' => 'Adrian Jones',
...
'
     ...
     *
     */
    public function ___markupValue(\ProcessWire\Page $page, \ProcessWire\Field $field, $value = null, $property = '') {
    ...
    public function getMatchQuery($query, $table, $subfield, $operator, $value) {
		...
		if($this->wire('database')->isOperator($operator)) {
			...
			// then let \ProcessWire\Fieldtype::getMatchQuery handle it instead
			return parent::getMatchQuery($query, $table, $subfield, $operator, $value);
		}
		// if we get here, then we're performing either %= (LIKE and variations) or *= (FULLTEXT and variations)
		$ft = new \ProcessWire\DatabaseQuerySelectFulltext($query);
     ...
     *
     */
    public function ___getCompatibleFieldtypes(\ProcessWire\Field $field) {
        return null;
    }
     ...
     *
     */
    public function getBlankValue(\ProcessWire\Page $page, \ProcessWire\Field $field) {
     ...
     *
     */
    public function ___wakeupValue(\ProcessWire\Page $page, \ProcessWire\Field $field, $value) {
     ...
     *
     */
    public function ___sleepValue(\ProcessWire\Page $page, \ProcessWire\Field $field, $value) {

        // throw error if value is not of the right type
        if(!$value instanceof Phone)
            throw new \ProcessWire\WireException("Expecting an instance of Phone");
    ...
    public function getModuleConfigInputfields(array $data) {
        ...
        $f->label = \ProcessWire\__('Phone Output Format', '/home/jpoukco/public_html/site/modules/FieldtypePhone/FieldtypePhone.module.php');
        $f->description = \ProcessWire\__("Select the default format to be used when outputting phone numbers.\n\nYou can define new formats for this dropdown select in the 'Phone Output Format Options' field below.", '/home/jpoukco/public_html/site/modules/FieldtypePhone/FieldtypePhone.module.php');
        $f->notes = \ProcessWire\__("This can be overridden on the Input tab of each 'phone' field.", '/home/jpoukco/public_html/site/modules/FieldtypePhone/FieldtypePhone.module.php');
        $f->addOption('', \ProcessWire\__('None', '/home/jpoukco/public_html/site/modules/FieldtypePhone/FieldtypePhone.module.php'));
        ...
        $f->attr('rows', 10);
        $f->label = \ProcessWire\__('Phone Output Format Options', '/home/jpoukco/public_html/site/modules/FieldtypePhone/FieldtypePhone.module.php');
        $f->description = \ProcessWire\__("Any formats listed here will be available from the Phone Output Format selector above, as well as the Format Override selector when entering data for phone number fields.\n\nOne format per line: `name | format | example numbers`\n\nEach component of the phone number is surrounded by { }\nThe names of the component parts are surrounded by [ ]\nTwo optional comma separated numbers after the component name are used to get certain parts of the number using the [PHP substr() function](http://php.net/manual/function.substr.php), allowing for complete flexibility.\nAnything outside the [ ] or { } is used directly: +,-,(,),x, spaces, etc - whatever you want to use.\n\nPlease send me a PR on Github, or post to the support forum any new formats you create that you think others would find useful.", '/home/jpoukco/public_html/site/modules/FieldtypePhone/FieldtypePhone.module.php');
        $inputfields->add($f);
 ...
 *
 */
class Phone extends \ProcessWire\WireData {
    ...
    public function set($key, $value) {
        ...
        if($key == 'country' || $key == 'area_code' || $key == 'number' || $key == 'extension') {
            ...
            if($this->field && !$this->field->allow_letters_input && !is_numeric($value) && !is_null($value) && $value != '') {
                ...
                throw new \ProcessWire\WireException("Phone Object only accepts numbers");
            }
        }
