...
class Bar
{
	...
	public function renderLoader()
	{
		...
		$async = true;
		require \ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.5.x/src/Tracy' . '/assets/Bar/loader.phtml';
	}
	...
	{
		ob_start(function () {});
		require \ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.5.x/src/Tracy' . '/assets/Bar/panels.phtml';
		require \ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.5.x/src/Tracy' . '/assets/Bar/bar.phtml';
	...
	private function renderAssets()
	{
		$css = array_map('file_get_contents', array_merge([
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.5.x/src/Tracy' . '/assets/Bar/bar.css',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.5.x/src/Tracy' . '/assets/Toggle/toggle.css',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.5.x/src/Tracy' . '/assets/Dumper/dumper.css',
...
();\n";
		...
		array_map('readfile', array_merge([
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.5.x/src/Tracy' . '/assets/Bar/bar.js',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.5.x/src/Tracy' . '/assets/Toggle/toggle.js',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.5.x/src/Tracy' . '/assets/Dumper/dumper.js',
			\ProcessWire\wire("config")->paths->root . 'site/modules/TracyDebugger/tracy-2.5.x/src/Tracy' . '/assets/BlueScreen/bluescreen.js',
